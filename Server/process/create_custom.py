...
# # If you want to run the `Create` process independently, ensure that the shared variables are properly initialized.
# # For example:
# if __name__ == "__main__":
#     shared_variables = {}  # Initialize shared variables appropriately
#     create_process = Create("transform", "example_id", ".obj", shared_variables)
#     create_process.run()
...
if __name__ == "__main__":
    ...
    create_process = Create("transform", "example_id", ".obj", shared_vars)
    create_process.run()

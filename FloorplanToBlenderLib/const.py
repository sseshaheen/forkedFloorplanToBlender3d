...
WALL_FILTER_KERNEL_SIZE = (5, 5)  # Increased from (3, 3)
WALL_FILTER_MORPHOLOGY_ITERATIONS = 3  # Increased from 2
WALL_FILTER_DILATE_ITERATIONS = 4  # Increased from 3
WALL_FILTER_DISTANCE = 5
WALL_FILTER_DISTANCE_THRESHOLD = [0.6, 0.2]  # Adjusted first value from 0.5 to 0.6 for stricter thresholding
WALL_FILTER_MAX_VALUE = 255
WALL_FILTER_THRESHOLD_TECHNIQUE = 0
MIN_CONTOUR_AREA = 150 #added in refactor
...
DEFAULT_IMAGE_PATH = "Images/Examples/compressed-uploadedFloorplans_Oq37pxGdFPYnvWbOL94ttbIFqD23_e6dea60b-30b8-4627-8aeb-c5e690b1999c-20240524-163742.jpeg"
